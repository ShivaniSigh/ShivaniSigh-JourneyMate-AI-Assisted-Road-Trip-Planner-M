...
function Header(){
    ...
    return (
        ...
        <div className="jumbotron p-3 mb-0 bg-primary text-light" style={ {  textDecorationColor:"black"}}>
            ...
            <h2 className="text-center"style={{paddingTop:"10px"}}>Welcome to TravelBuddy</h2>
